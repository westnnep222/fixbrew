  ...
  def self.install
    ...
    Dir.chdir 'glibc_build' do
      ...
      Dir.chdir CREW_DEST_LIB_PREFIX do
        ...
        # and __strtof128_nan
        if ARCH == 'x86_64' && Gem::Version.new(@libc_version.to_s) >= Gem::Version.new('2.38')
        ...
        @libraries -= ['libpthread'] if Gem::Version.new(@libc_version.to_s) >= Gem::Version.new('2.38')
        @libraries -= ['libc'] if Gem::Version.new(@libc_version.to_s) >= Gem::Version.new('2.38') && ARCH == 'x86_64'
        # Also save our copy of libm.so.6 since it has the float128 functions
        @libraries -= ['libm'] if Gem::Version.new(@libc_version.to_s) >= Gem::Version.new('2.38') && ARCH == 'x86_64'
